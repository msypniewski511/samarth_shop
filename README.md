...
```sh
git clone https://github.com/nickjj/docker-rails-example samarth_shop
cd samarth_shop
...
The app is named `samarth_shop` right now but chances are your app will be a different
name. Since the app is already created we'll need to do a find / replace on a
few variants of the string "samarth_shop" and update a few Docker related resources.
